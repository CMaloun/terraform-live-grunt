...
#######################################
Copy-Item "Datacenter_Partition_Conf.csv" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
Copy-Item "ConfigurationFileTemplateAS.ini" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
Copy-Item "function_Add-LoginToLocalPrivilege.ps1" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
Copy-Item "function_TS_Create_Partition.ps1" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
Copy-Item "Get-PendingReboot.ps1" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
Copy-Item "Install_SGBD_Node_AS.ps1" -Destination "C:\Installation SQL SERVER 2014 V1.1\Sources"
